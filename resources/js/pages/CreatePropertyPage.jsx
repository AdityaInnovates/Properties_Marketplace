...
function CreatePropertyPage() {
    ...
    return (
        <Layout title="Create Property Listing">
            <div className="container mx-auto px-4 py-8">
                ...
                <Card className="mx-auto max-w-2xl">
                    <CardHeader>
                        ...
                        <CardDescription>
                            Fill in the details below to create a new property listing. AI will automatically generate similar property
                            recommendations.
                        </CardDescription>
                    </CardHeader>
...
export default withAuth(CreatePropertyPage);
